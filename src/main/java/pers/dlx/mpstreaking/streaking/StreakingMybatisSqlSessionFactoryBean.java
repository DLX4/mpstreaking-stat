...
/**
 * 完全拷贝自MybatisSqlSessionFactoryBean，替换了configuration属性
 ...
 * @since 2017-01-04
 */
public class StreakingMybatisSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    // TODO 使用 StreakingMybatisConfiguration
    private StreakingMybatisConfiguration configuration;
     ...
     * TODO 这里的入参使用 StreakingMybatisConfiguration 而不是 Configuration
     *
     * @param configuration MyBatis configuration
     * @since 1.3.0
     */
    public void setConfiguration(StreakingMybatisConfiguration configuration) {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        if (this.configuration != null) {
            ...
            // TODO 使用 StreakingMybatisConfiguration
            targetConfiguration = new StreakingMybatisConfiguration();
